...
PreparedStatement pstmt_dcafixer25 = conn.prepareStatement("SELECT COUNTRY_ID, COUNTRY_NAME, REGION_ID FROM COUNTRIES WHERE COUNTRY_NAME = ? OR REGION_ID = ?");
