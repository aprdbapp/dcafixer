...
PreparedStatement pstmt_dcafixer24 = conn.prepareStatement("SELECT EMPLOYEE_ID, COMMISSION_PCT FROM EMPLOYEES WHERE COMMISSION_PCT <> ?");
pstmt_dcafixer24.setObject(1, val1);
