...
PreparedStatement pstmt_dcafixer25 = conn.prepareStatement("SELECT DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID FROM DEPARTMENTS WHERE DEPARTMENT_NAME >= ? OR MANAGER_ID > ?");
