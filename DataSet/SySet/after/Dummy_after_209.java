...
PreparedStatement pstmt_dcafixer24 = conn.prepareStatement("SELECT EMPLOYEE_ID, DEPARTMENT_ID FROM EMPLOYEES WHERE DEPARTMENT_ID = ?");
pstmt_dcafixer24.setObject(1, val2);
