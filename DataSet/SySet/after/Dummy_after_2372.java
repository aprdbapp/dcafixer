...
PreparedStatement pstmt_dcafixer25 = conn.prepareStatement("SELECT EMPLOYEE_ID, START_DATE, END_DATE FROM JOB_HISTORY WHERE START_DATE <> ? OR END_DATE < ?");
