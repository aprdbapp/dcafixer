...
PreparedStatement pstmt_dcafixer25 = conn.prepareStatement("SELECT EMPLOYEE_ID, END_DATE, JOB_ID FROM JOB_HISTORY WHERE END_DATE >= ? AND JOB_ID > ?");
