...
PreparedStatement pstmt_dcafixer24 = conn.prepareStatement("SELECT EMPLOYEE_ID, EMAIL FROM EMPLOYEES WHERE EMAIL <> ?");
pstmt_dcafixer24.setObject(1, var1);
