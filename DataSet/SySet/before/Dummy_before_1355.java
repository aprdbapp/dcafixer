...
public class Dummy_before_1355 {
	...
	public static int sendRequest(Connection conn, String rand0 ,String val1 ) throws SQLException {
		String sql = "SELECT DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID FROM DEPARTMENTS WHERE DEPARTMENT_NAME >=" + val1+" AND MANAGER_ID >" + rand0;
