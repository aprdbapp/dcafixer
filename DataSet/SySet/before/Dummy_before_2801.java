...
public class Dummy_before_2801 {
	...
	public static int sendRequest(Connection conn, String counter ) throws SQLException {
		...
		int rs = stmt.executeUpdate("INSERT into bestOffices(name,location) select name,location from offices   where numberEmployees >"+counter);
		return rs;
	}
}