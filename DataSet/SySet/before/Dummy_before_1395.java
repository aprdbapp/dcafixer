...
public class Dummy_before_1395 {
	...
	public static int sendRequest(Connection conn, String rand0 ,String val2 ) throws SQLException {
		String sql = "SELECT DEPARTMENT_ID, DEPARTMENT_NAME, MANAGER_ID FROM DEPARTMENTS WHERE DEPARTMENT_NAME <>" + val2+" AND MANAGER_ID <" + rand0;
