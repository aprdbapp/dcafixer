...
//    	boolean print =true;
    	if(print) {
			System.out.println("======== @operationProcessor =========");
		}
    	ActionParts ap = GetOpParts(op, false);
    	if(print) {
			System.out.print("Action: "+ op);
		}
    	String newLine = "";
...
//        boolean print =false;
        ...
        if(print) {
			System.out.println("curr "+curr+" line: "+line+"\n next: "+next);
		}
        // Collect the following data:
        //Action Name, Node Type, Code Change,
        if(print)
		 {
			System.out.println("Action Name: "+ap.actionName);
			//String action_name = ap.actionName;
		}

        if(print) {
			System.out.println("Node Type: "+ap.nodeType);
		}
        if(print) {
			System.out.println("Code Change: "+ap.codeChange);
		}
        if(print) {
			System.out.println("CC.From: "+ap.ccFrom);
		}
        if(print) {
			System.out.println("CC.To: "+ap.ccTo);
		}
        if(print) {
			System.out.println("Pos: "+ap.pos);
		}
...
//				}else
        ...
        if (action instanceof Update) {
        	if(ap.nodeType.equals("VariableRead")){
        		...
        		if(print)
				 {
					System.out.print("Update, VariableRead: ");//+newLine);
				}
        	}
        	...
        	if(ap.nodeType.equals("LocalVariable")){
        		...
        		newLine = ap.ccTo+";";
        		if(print) {
					System.out.print("Update, LocalVariable: ");
				}
        	}
        	if(ap.nodeType.equals("Literal")){
        		newLine = line.replace(ap.ccFrom, ap.ccTo);
        		if(print) {
					System.out.print("Update, Literal: ");
				}
        	}
        	if(curr != next ) {
				newLine = "- " + line + "\n+ "+ newLine;
        ...
        if (action instanceof Move) {
        	...
        	if (ap.nodeType.equals("TypeReference") ) {
        		...
        		if(print)
				 {
					System.out.print("Move, TypeReference: ");//+newLine);
				}
        	}
        	...
        	if(ap.nodeType.equals("FieldWrite")) {
        		...
        		if(print)
				 {
					System.out.print("Move, FieldWrite: ");//+newLine);
				}
        	}
        ...
        if (action instanceof Delete) {
        	...
        	if (ap.nodeType.equals("Assignment") ) {
        		...
        		if(print)
				 {
					System.out.print("Delete, Assignment : ");//+newLine);
...
//                	}else  {
        		...
        		if(print)
				 {
					System.out.print("Delete, FieldRead : ");//+newLine);
				}
        	...
        	if (ap.nodeType.equals("LocalVariable")) {
        		newLine = "- "+ line;
        		if(print) {
					System.out.println("Delete, LocalVariable : "+newLine);
				}
        	}
...
//        				newLine = line.replace(parts[1], "();");
        		...
        		if(print) {
					System.out.print("Delete, BinaryOperator : ");
				}
        		...
        		if(print) {
					System.out.println("Delete, BinaryOperator: "+newLine);
				}
        	}
...
//				}else
        ...
        if (action instanceof Delete) {
        	...
        	if (ap.nodeType.equals("Assignment") || ap.nodeType.equals("Literal")) {
        		...
        		if(print)
				 {
					System.out.print("Delete, Assignment | Literal: "+newLine);
//        		String parts[] = line.split("=",2);
//        		codeToRemove = parts[1].trim();
//        		if(codeToRemove.endsWith(";") && !ap.codeChange.trim().endsWith(";")) {
//        			codeToRemove = codeToRemove.replaceFirst(".$",""); //remove last letter i.e., ";"
