...
//    	boolean print =true;
    	...
    	if(print) System.out.print("Action: "+ op);
    	String newLine = "";
...
//        op.getSrcNode().get
    int pos =0;
        ...
        if (element == null) {
            // some elements are only in the gumtree for having a clean diff but not in the Spoon metamodel
            /*++++*/
            if(print) System.out.print(stringBuilder + " fake_node(" + action.getNode().getMetadata("type") + ")");
            //return stringBuilder.toString() + " fake_node(" + action.getNode().getMetadata("type") + ")";
            return pos;
        }
...
//            if(print) System.out.print(" s=" + s + ", newline= "+newline);
        ...
        /*++++*/
        if(print) System.out.print(stringBuilder);
        return pos;
    }
