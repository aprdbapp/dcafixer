...
//				}
	...
	public static void start_dcafixer(String projectName, String projectSrc, String projectJar, String outDir, String patternsPath) throws Exception {
		//String CsvDir = G.CsvDir;
		G.PatternsPath = patternsPath;
		G.ResultsPath = outDir +projectName;
...
//		out/dcafixer-report/
		//String reportDir = outDir +"/dcafixer-report/"+projectName+"/report.txt";
		String reportDir = outDir +projectName+"/report.txt";
