...
public class LocatingPIs {
	...
	static String expPath ="/Users/dareen/Fixer/DCAFixer_Experimets/";
			...
			for (String kq : key_query) {
				...
				if (parts.length == 2) {
					...
					if (seed.equals("prepareStatement")) {
						if(print) {
							System.out.println("BRANCH 3 - PS");
						}
...
//			System.out.println(s.toString());
						...
						if(print) {
							System.out.println("BRANCH 4 - EQ EU");
						}
					...
					if (SignSlice.qp.get_qs_ql() == null) {if(print) {
						...
						if (s.get_T() == '_') {
							System.out.println("** Secure (PS is used): "+ s);// -,-,null
						} else {
							System.out.println("** Secure (WL is used): "+ s);// -,?,[v,?]
						}
					} else if (s.get_V() == 'q' || s.get_V() == 'Q') {
						if (s.get_I().contains('v') && !s.get_I().contains('c') && !s.get_I().contains('t')) {
//				QV++; //Q,?,[v]
							System.out.println("** Column value is input: "+ s); // Q,?,[v]
						} else if (!s.get_I().contains('v') && (s.get_I().contains('c') || s.get_I().contains('t'))) {
//				QCT = 0; //Q,?,[c&|t]
							System.out.println("** Column/Table name is input: "+ s); // Q,?,[c&|t]
						} else if (s.get_I().contains('a')) {

							System.out.println("** All query is user input: "+ s); // Q,?,[a]
						}
					} else if (s.get_V() == 'S') {
						if (is_ps) {
							System.out.println(
									"** Prepared stmt is used incorrectly (Column/Table name is user input)"+ s);// S,?,[c&|t]
						} else {
							System.out.println("** Wrong fucntion used with the query"+ s);// S,?,[v]
						}
					} else if (s.get_V() == 'F') {
//			Qparser++;
//			failedCasesFiles.add(content);

						System.out.println("**** Failed to parse the query:"+ s +"\n" + query);
					}
...
//		String proj1_src = "/Users/dareen/Fixer/DCAFixer_Experimets/hibernate-orm-main";
//		String proj1_jar = "/Users/dareen/Fixer/DCAFixer_Experimets/hibernate-orm-main.jar";
//		String proj1_Csv = "/Users/dareen/Fixer/DCAFixer_Experimets/Csv_files/" + StrUtil.get_classname(proj1_src)+".csv";
...
//		int All_N, All_P, All_DN, All_DP, All_TP, All_TN, All_FP, All_FN;
		...
		String CsvDir = "/Users/dareen/Fixer/DCAFixer_Experimets/Excel_files/";
//		String proj1Src= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/banking-app-devkala48-master/src";
//		String proj1Jar= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/jar_files/banking-app.jar";
//		String proj1Csv = CsvDir + "banking-app.csv";
//		P= 4; N = 11;
//		analyze_project(proj1Jar, proj1Src, proj1Csv, false, P, N);
//
//
//		String proj2Src= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/Online-Book-Store-System-master/src/workspace";
//		String proj2Jar= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/jar_files/BookStore.jar";
//		String proj2Csv = CsvDir + "BookStore.csv";
//		P= 46; N = 0;
//		analyze_project(proj2Jar, proj2Src, proj2Csv, false, P, N);
//
//
//		String proj3Src= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/crawledemo-master/property/src/com/property";
//		String proj3Jar= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/jar_files/crawledemo_property.jar";
//		String proj3Csv = CsvDir + "crawledemo_property.csv";
//		P= 3; N = 0;
//		analyze_project(proj3Jar, proj3Src, proj3Csv, false, P, N);
//
//
//		String proj4Src= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/Ecomerce--master/Ecomerce/src/ecomerce";
//		String proj4Jar= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/jar_files/Ecomerce.jar";
//		String proj4Csv = CsvDir + "Ecomerce.csv";
//		P= 79; N = 15;
//		analyze_project(proj4Jar, proj4Src, proj4Csv, false, P, N);
//
//
//		String proj5Src= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/fiftyfiftystockscreener-master/src/com/eddiedunn";
//		String proj5Jar= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/jar_files/fiftyfiftystockscreener.jar";
//		String proj5Csv = CsvDir + "fiftyfiftystockscreener.csv";
//		P= 32; N = 4;
//		analyze_project(proj5Jar, proj5Src, proj5Csv, false, P, N);
//
//
//		String proj6Src= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/GUI-DBMS-master/TableEasy/src/tableeasy";
//		String proj6Jar= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/jar_files/GUI-DBMS.jar";
//		String proj6Csv = CsvDir + "GUI-DBMS.csv";
//		P= 33; N = 20;
//		analyze_project(proj6Jar, proj6Src, proj6Csv, false, P, N);
//
//
//		String proj7Src= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/InventarioWeb-master/src/java";
//		String proj7Jar= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/jar_files/InventarioWeb.jar";
//		String proj7Csv = CsvDir + "InventarioWeb.csv";
//		P= 1; N = 31;
//		analyze_project(proj7Jar, proj7Src, proj7Csv, false, P, N);
//
//
//		String proj8Src= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/JavaGit-master/src";
//		String proj8Jar= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/jar_files/JavaGit-master.jar";
//		String proj8Csv = CsvDir + "JavaGit-master.csv";
//		P= 2; N = 1;
//		analyze_project(proj8Jar, proj8Src, proj8Csv, false, P, N);
//
//
//		String proj9Src= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/mariadb-connector-j-master/src";
//		String proj9Jar= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/jar_files/mariadb.jar";
//		String proj9Csv = CsvDir + "mariadb.csv";
//		P= 18; N = 1744;
//		analyze_project(proj9Jar, proj9Src, proj9Csv, false, P, N);
//
//
//		String proj10Src= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/TFG_PC-master/src";
//		String proj10Jar= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/jar_files/TFG_PC-master.jar";
//		String proj10Csv = CsvDir + "TFG_PC-master.csv";
//		P= 77; N = 1;
//		analyze_project(proj10Jar, proj10Src, proj10Csv, false, P, N);
//
//
//		String proj11Src= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/vSync-master/vSync/src";
//		String proj11Jar= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/jar_files/vSync.jar";
//		String proj11Csv = CsvDir + "vSync.csv";
//		P= 20; N = 1;
//		analyze_project(proj11Jar, proj11Src, proj11Csv, false, P, N);
//
//
//		String proj12Src= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/zjjava-master";
//		String proj12Jar= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/jar_files/zjjavaJDBC.jar";
...
//		analyze_project(proj04Jar, proj04Src, projCsv, false, P, N);
		...
		//============== Test Dataset ==================
//		String test01Src= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/test/EPL441Clinic-master";
...
//		analyze_project(test01Jar, test01Src, projCsv, true, P, N);
		...
		String test02Src= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/test/Hotel-Management---Java-master/src";
		...
		String test03Src= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/test/iTrust-v23-master/iTrust/src";
		...
		String test04Src= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/test/Java_BBDD-master/src";
		...
		String test05Src= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/test/java-homework-10-master/src";
		...
		String test06Src= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/test/Momow1-master/src";
		//"/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/test/Momow1-master/src/java";
		...
		String test07Src= "/Users/dareen/Fixer/DCAFixer_Experimets/SQLIFix-projects/test/Naegling-GUI-master/src";
		...
		//-----------------------------------------------------
//		String f1 = "/Users/dareen/Fixer/DCAFixer_Experimets/hibernate-orm-main/hibernate-core/src/test/java/org/hibernate/orm/test/cache/RefreshUpdatedDataTest.java";
