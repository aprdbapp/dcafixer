...
public class G {
	public static final String JarPath = "/Users/dpc100/Fixer/Experiments/TrainingCases/smallbank.jar";
	public static final String SrcPath ="/Users/dpc100/NetBeansProjects/smallBank/src/TSet/";
	public static final String SCPath = "/Users/dpc100/Fixer/tmp/TSet/Slices";
	public static final String testTmpPath = "/Users/dpc100/tmp";
	...
	public static final List<String> IPList = new ArrayList<>(Arrays.asList("executeQuery", "executeUpdate", "execute", "getConnection", "createStatement", "Properties", "PreparedStatement"));
	public static final List<String> ConnIPList = new ArrayList<>(Arrays.asList("getConnection", "Properties"));
	public static final List<String> ExIPList = new ArrayList<>(Arrays.asList("executeQuery", "executeUpdate", "execute"));
	public static final List<String> UIPointsList = new ArrayList<>(Arrays.asList("Scanner", "nextLine", "nextFloat", "nextDouble", "nextByte", "nextLine", "nextBoolean", "nextLong", "nextShort", "nextBigInteger", "nextBigDecimal", 
																				"BufferedReader", "read", "readLine", 
																				"InputStream", "FileInputStream", "read", "JTextField", "getText", "getSelectedText"));
