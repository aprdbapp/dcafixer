...
public class G {
	...
	public static String PatternsPath = "patterns/";
	public static String ResultsPath = "out/dcafixer-report/";//"/Users/dareen/Fixer/DCAFixer_Experimets/Results/";
	...
	public static final String SCPath = "patterns";
	...
	public static final String SQLI_VSlicesPath = PatternsPath + "SQLIV/Slices/vSlices";
	public static final String SQLI_TmpVSlicesPath = PatternsPath + "SQLIV/Slices/tmp";
	public static final String SQLI_SSlicesPath = PatternsPath + "SQLIV/Slices/sSlices";
	public static final String SQLI_patchesPath = PatternsPath + "SQLIV/Slices/patches";//PS
	public static final String SQLI_patchesPath2 = PatternsPath + "SQLIV/Slices/patches2";//WL

	public static final String CONN_VSlicesPath = PatternsPath + "CONN/Slices/vSlices";
	public static final String CONN_TmpVSlicesPath = PatternsPath + "CONN/Slices/tmp";
	public static final String CONN_SSlicesPath = PatternsPath + "CONN/Slices/sSlices";
	public static final String CONN_patchesPath = PatternsPath + "CONN/Slices/patchesHC";//HC
	public static final String CONN_patchesPath2 = PatternsPath + "CONN/Slices/patchesDT";//Data type!


	public static final String testTmpPath = "out/dcafixer-report/";//"out"
