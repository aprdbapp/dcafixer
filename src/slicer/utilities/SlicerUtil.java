...
//		if(Print) System.out.println("MM :"+methodName);
		...
		if(Print) System.out.println("Hello !");
		for (Iterator<? extends CGNode> it = cg.iterator(); it.hasNext();) {
			CGNode n = it.next();
			if(Print) System.out.println("Hello !!");
			if(Print) System.out.println("node :"+n.toString());
...
//				continue;
//			} else 
//			if(Print) System.out.println("mmmmmm@ "+n.getMethod().getName().toString());
//			if(Print) System.out.println("cccc@ "+n.getMethod().getDeclaringClass().getName().toString());
//			if(Print) System.out.println("L" + className);
			if (n.getMethod().getDeclaringClass().getName().toString().equals("L" + className)) {
...
//				}
				...
				for (Iterator<ISSABasicBlock> bit = ir.getBlocks(); bit.hasNext();){
					...
					for(Iterator<SSAInstruction> bInstit = bb.iterator(); bInstit.hasNext();) {
						SSAInstruction inst = bInstit.next();
						if (inst != null) {
							int irLineNo = StmtFormater.IRIdexToLineNumber_stmtFormat(ir, inst.iIndex());
							 if(Print) 
								 System.out.println("### irLineNo= " +irLineNo+", and lno= "+lno +"\ninst: "+inst.toString());
...
//		System.out.println("NNNNN" + cg.getClassHierarchy().getNumberOfClasses());
...
//				return new NormalStatement(n, j);
		...
		if(Print) System.out.println("I'm leaving find_seed_by_lno_and_key ");
...
//			if(Print) System.out.println("-------------------");
			if (s != null) {
				System.out.println(s.toString()); // if(Print) System.out.println(StmtFormater.format(s));
			}
//			if(Print) System.out.println("===================");
		}
	}
