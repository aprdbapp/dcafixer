...
public class StrUtil {
	...
	public static boolean isUIPoint(String str) {
		if (G.UIPointsList.contains(str))
			return true;
		return false;
	}
...
//		        	 System.err.println("~~~~~~~~~"+commonStr+"~");
	...
	// "/Users/dpc100n/eclipse-workspace/Calculator/src/add2.java"
